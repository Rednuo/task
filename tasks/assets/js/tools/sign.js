...
const apiHelper = {
    ...
    getAesString: function (data) {
        return EncJS.AES.encrypt(data, this.key, this);
    },
    getDAesString: function (data) {
        return EncJS.AES.decrypt(data, this.key, this).toString(EncJS.enc.Utf8);
    },
};
...
export default {
    ...
    unformat(data) {
        return JSON.parse(apiHelper.getDAesString(data));
    },
};